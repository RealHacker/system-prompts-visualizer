...
function generateWordCountVisualization() {
    ...
    const sections = [
        { name: 'Important Rules', words: 86, color: '#4361ee', percentage: 6.6 },
        { name: 'Development Environment', words: 79, color: '#3f37c9', percentage: 6.0 },
        { name: 'Web Search', words: 91, color: '#4895ef', percentage: 7.0 },
        { name: 'Chat Completions', words: 87, color: '#4cc9f0', percentage: 6.6 },
        { name: 'Standard Technology Stack', words: 83, color: '#f72585', percentage: 6.3 },
        { name: 'UI/UX Design Standards', words: 137, color: '#e63946', percentage: 10.5 },
        { name: 'Coding Standards', words: 60, color: '#7209b7', percentage: 4.6 },
        { name: 'Other Sections', words: 587, color: '#560bad', percentage: 44.8 }
    ];
...
// Load data from JSON and update the page
function loadData() {
