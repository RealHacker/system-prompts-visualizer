...
function generateWordCountVisualization() {
    ...
    const sections = [
        { name: 'Agency', words: 791, color: '#4361ee', percentage: 24.5 },
        { name: 'Oracle', words: 344, color: '#3f37c9', percentage: 10.6 },
        { name: 'Task Management', words: 375, color: '#4895ef', percentage: 11.6 },
        { name: 'Conventions & Rules', words: 376, color: '#4cc9f0', percentage: 11.6 },
        { name: 'Communication', words: 637, color: '#f72585', percentage: 19.7 },
        { name: 'Environment', words: 211, color: '#e63946', percentage: 6.5 },
        { name: 'Tools', words: 50, color: '#7209b7', percentage: 1.5 },
        { name: 'Other', words: 459, color: '#560bad', percentage: 14.2 }
    ];
