...
function generateWordCountVisualization() {
    ...
    const sections = [
        { name: 'Overview', words: 320, color: '#4361ee', percentage: 20.3 },
        { name: 'Workflow', words: 280, color: '#3f37c9', percentage: 17.7 },
        { name: 'Tools', words: 450, color: '#4895ef', percentage: 28.5 },
        { name: 'Context', words: 180, color: '#4cc9f0', percentage: 11.4 },
        { name: 'Rules', words: 200, color: '#f72585', percentage: 12.7 },
        { name: 'Coding', words: 120, color: '#e63946', percentage: 7.6 },
        { name: 'Other', words: 30, color: '#7209b7', percentage: 1.8 }
    ];
