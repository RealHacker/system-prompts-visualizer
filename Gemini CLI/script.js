...
function generateWordCountVisualization() {
    ...
    // Section data with word counts and colors (based on analysis)
    const sections = [
        { name: 'Core Mandates', words: 356, color: '#4361ee', percentage: 13.0 },
        { name: 'Software Engineering Tasks', words: 281, color: '#3f37c9', percentage: 10.3 },
        { name: 'New Applications', words: 572, color: '#4895ef', percentage: 20.9 },
        { name: 'Tool Usage', words: 323, color: '#4cc9f0', percentage: 11.8 },
        { name: 'Examples', words: 578, color: '#f72585', percentage: 21.1 },
        { name: 'Rules & Security', words: 151, color: '#e63946', percentage: 5.5 },
        { name: 'Git Repository', words: 210, color: '#7209b7', percentage: 7.7 },
        { name: 'Other', words: 266, color: '#560bad', percentage: 9.7 }
    ];
